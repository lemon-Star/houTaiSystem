...
public class SmartUpload
{
        ...
        throws ServletException, IOException, SmartUploadException
    {
        ...
        for(m_currentIndex++; m_currentIndex < m_totalBytes; m_currentIndex = m_currentIndex + 2)
        {
            ...
            if(flag3)
            {
            	com.upload.File file = new com.upload.File();
                file.setParent(this);
            ...
            } else
            {
                ...
                if(this.encoding!=null && !"".equals(this.encoding.trim())){
                	s11= new String(m_binArray, m_startData, (m_endData - m_startData) + 1,this.encoding.trim());
                }else{
                	s11= new String(m_binArray, m_startData, (m_endData - m_startData) + 1);
                }
        ...
        throws ServletException, IOException, SmartUploadException
    {
        ...
        if(s2 == null)
            m_response.setHeader("Content-Disposition", m_contentDisposition + " filename=" + toEncodingString(getFileName(s)));
        else
        if(s2.length() == 0)
    ...
    private String getDataHeader()
    {
        ...
        if ((this.encoding != null) && (this.encoding.length() > 0))
			try {
				s = new String(this.m_binArray, i, j - i + 1, this.encoding);
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}
		else {
          s = new String(this.m_binArray, i, j - i + 1);
        }
        return s;
    }
    ...
    public String toEncodingString(String s)
    {
      if ((this.encoding == null) || (this.encoding.length() == 0)) {
        return s;
      }
      ...
      for (int i = 0; i < s.length(); ++i) {
        ...
        if ((c >= 0) && (c <= 255)) {
          ...
          byte[] b;
          try {
            b = Character.toString(c).getBytes(this.encoding);
          } catch (Exception ex) {
