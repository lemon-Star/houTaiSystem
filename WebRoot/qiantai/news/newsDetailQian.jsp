		...
		<TABLE class=MainTable style="MARGIN-TOP: 0px" cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
				<TR>
					<TD class=Main  height=111>
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="754" border=0 height="70">
								<TR>
									<TD class=head>
								...
								<TR align="left">
									<TD>
									    <table border="0" cellspacing="8" cellpadding="0" width="744" height="155">
									        <tr>
									            <td width="200"><s:property value="#request.news.newsTitle"/></td>
									            <td>发布时间：<s:property value="#request.news.newsDate"/></td>
									        </tr>
									        <tr>
									            <td colspan="2"><s:property value="#request.news.newsContent" escape="false"/></td>
									        </tr>
									    </table>
									</TD>
								</TR>
